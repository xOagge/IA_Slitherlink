...
class Slitherlink(Problem):
    ...
    def rank_actions(self, state: SlitherlinkState, actions: list) -> list:
        ...
        for edge in board.all_drawn_edges:
            ...
            degree_before[v1] = degree_before.get(v1, 0) + 1
        ...
        for action in actions:
            ...
            for edge in board_copy.all_drawn_edges:
                ...
                degree_after[v1] = degree_after.get(v1, 0) + 1
    ...
    def actions(self, state: SlitherlinkState):
        ...
        if valid_actions:
            ...
            ranked = self.rank_actions(state, valid_actions)
            return tuple(ranked)
            ...
            for c in range(state.board.cols):
                ...
                if hint == 3: # Encontrou o melhor ponto de partida
                    ...
                    if valid_edges:
                        ...
                        return tuple(self.rank_actions(state, valid_edges))
